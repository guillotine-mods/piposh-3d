...
_Last edited: 2026-08-06 (GB-7 round 6: fixed a warp_mouse()-induced 180-degree spin on reset; added GB-8 for the still-open bullet-vs-target collision precision issue — investigated, a naive fix regressed, needs a more careful follow-up)._
