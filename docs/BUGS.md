...
_Last edited: 2026-08-04 (GB-7 round 2: panel draw-order hardening, retry camera-snap/deadlock fix, and the missing-crosshair/screen_size fix; all pending confirmation)._
